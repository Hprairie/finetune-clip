...
python benchmark/main.py \
    ...
    --pretrained "$WORK/research/finetune-clip/open_clip/src/logs/ViT-B-32-LoRA-Rank32/checkpoints/epoch_1.pt" \
    --finetune-path "$WORK/research/finetune-clip/open_clip/src/logs/ViT-B-32-LoRA-Rank32" \
    ...
    --name "LoRA-Finetune-With-Reranker-CC3M-Text-Token-Epoch1-FG-5k" \
    --k 1 5 10 \
    --batchsize 128 \
    --reg-retrieval
