...
class CLIP(nn.Module):
    ...
    def encode_image(self, image, normalize: bool = False, return_tokens: bool = False, second_to_last: bool = False):
        if return_tokens or second_to_last:
            ...
            features, tokens = self.visual(image, second_to_last=second_to_last)
    ...
    def encode_text(self, text, normalize: bool = False, return_tokens: bool = False, second_to_last: bool = False):
